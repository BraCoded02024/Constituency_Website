...
const quickLinks = [
  { title: 'Register Delegate', description: 'Join the constituency registry and stay informed about party activities.', icon: UserPlus, href: '/register', color: 'text-npp-blue', bg: 'bg-npp-blue/10' },
...
function HeroSection() {
  return (
    <section className="relative bg-npp-blue overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-14 sm:py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <motion.div {...sectionFade(0.05)}>
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full mb-4">
              <Shield size={14} className="text-npp-red-light mr-1.5 shrink-0" />
              <span className="text-white/90 text-xs font-medium">{demoContent.platform.tagline}</span>
            </div>

            <p className="text-npp-red-light text-xs font-semibold tracking-wide uppercase mb-2">
              {demoContent.platform.heroEyebrow}
            </p>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-4 lg:mb-6">
              Party Operations for{' '}
              <span className="text-npp-red-light">{demoContent.constituency.shortName}</span>
            </h1>

            <p className="text-white/85 text-sm sm:text-base lg:text-lg mb-6 lg:mb-8 leading-relaxed max-w-xl">
              {demoContent.platform.welcomeLong}
            </p>

            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/register" className="bg-npp-red text-white px-6 py-3 rounded-xl font-semibold hover:bg-npp-red-dark transition-all shadow-xl flex items-center justify-center gap-2 text-sm sm:text-base">
                <UserPlus size={18} className="shrink-0" />
                Register as Delegate
              </Link>
              <Link href="/concerns" className="bg-white/10 backdrop-blur-sm text-white px-6 py-3 rounded-xl font-semibold hover:bg-white/20 transition-all border border-white/20 flex items-center justify-center gap-2 text-sm sm:text-base">
          ...
          <motion.div {...sectionFade(0)} className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/75 text-sm sm:text-base max-w-md leading-relaxed">
                Join NPP Suynani East programmes — register as a delegate, volunteer with your community, or stay informed on constituency development.
              </p>
            </div>
